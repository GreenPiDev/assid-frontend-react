export const KVKK_TEXT = `KİŞİSEL VERİLERİN KORUNMASI AYDINLATMA METNİ (KVKK)

Veri Sorumlusu: Ankara Siteler Sanayici ve İş İnsanları Derneği (ASSİD)
Adres: Güneşevler Mah. 21 Cad. No: 5/8 Altındağ, Ankara
E-posta: info@assid.com.tr
Tel: +90 530 233 27 43

1) İşlenen Kişisel Veriler
Başvuru ve üyelik süreçleri kapsamında; kimlik (ad-soyad, T.C. kimlik no vb.), iletişim (telefon, e-posta, adres), mesleki (unvan, şirket bilgileri), üyelik başvuru bilgileri, referans bilgileri, imza ve başvuru eklerinde yer alan bilgiler işlenebilir.

2) Kişisel Verilerin İşlenme Amaçları
Kişisel verileriniz; üyelik başvurusunun alınması, değerlendirilmesi ve sonuçlandırılması, üyelik kayıtlarının oluşturulması ve üyelik ilişkisinin yürütülmesi, dernek faaliyetlerinin planlanması ve üyelerin bilgilendirilmesi, mali süreçlerin (aidat/ödemeler) takibi, mevzuattan doğan yükümlülüklerin yerine getirilmesi amaçlarıyla işlenebilir.

3) Hukuki Sebepler
Kişisel verileriniz, KVKK'nın 5. maddesinde belirtilen; kanunlarda öngörülmesi, sözleşmenin kurulması/ifası, veri sorumlusunun hukuki yükümlülüğü ve meşru menfaat hukuki sebeplerine dayanarak işlenebilir. Gerekli hallerde açık rızanız alınır.

4) Aktarım
Kişisel verileriniz; amaçlarla sınırlı olmak üzere, mevzuatın izin verdiği ölçüde; yetkili kamu kurumları, mali/denetim süreçlerinde hizmet alınan tedarikçiler ve ilgili iş ortaklarına aktarılabilir.

5) Saklama Süresi
Kişisel verileriniz, işleme amacının gerektirdiği süre boyunca ve ilgili mevzuatta öngörülen zaman aşımı/saklama süreleri kapsamında saklanır; süre sonunda silinir, yok edilir veya anonim hale getirilir.

6) KVKK Kapsamındaki Haklarınız
KVKK'nın 11. maddesi kapsamında; kişisel verilerinize ilişkin bilgi talep etme, düzeltme, silme, işlemeye itiraz ve diğer haklara sahipsiniz. Başvurularınızı yazılı olarak veya e-posta üzerinden Derneğe iletebilirsiniz.
...
Madde 4 — Faaliyet Konuları: Dernek, amacı doğrultusunda; üye buluşmaları, toplantı, panel, seminer, eğitim, çalıştay düzenlemek; proje geliştirmek, raporlama/araştırma yapmak, yayınlar hazırlamak; kamu kurumları, üniversiteler, STK'lar ve özel sektör ile iş birliği geliştirmek; üyeler arası iletişim ve iş ağı (network) faaliyetleri yürütmek; sektörel gelişim ve nitelikli iş gücü için programlar yürütmek; ilgili mevzuata uygun şekilde temsil, tanıtım ve kurumsal iletişim çalışmaları yapabilir.
